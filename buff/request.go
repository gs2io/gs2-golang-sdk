		...
		if v, ok := d["buffEntryName"]; ok && v != nil {
			...
			if err := json.Unmarshal(*v, &temp); err == nil {
				...
				case int64:
					...
					p.BuffEntryName = &strValue
				default:
					_ = json.Unmarshal(*v, &p.BuffEntryName)
				}
			}
		}
	}
...
func NewGetBuffEntryModelRequestFromDict(data map[string]interface{}) GetBuffEntryModelRequest {
	return GetBuffEntryModelRequest{
		...
		BuffEntryName: func() *string {
			v, ok := data["buffEntryName"]
			if !ok || v == nil {
				return nil
			}
			return core.CastString(data["buffEntryName"])
		}(),
	}
}
...
type PreUpdateCurrentBuffMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentBuffMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentBuffMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentBuffMasterRequestFromJson(data string) (PreUpdateCurrentBuffMasterRequest, error) {
	req := PreUpdateCurrentBuffMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentBuffMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentBuffMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentBuffMasterRequest {
...
func (p PreUpdateCurrentBuffMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentBuffMasterRequest) Pointer() *PreUpdateCurrentBuffMasterRequest {
	return &p
}
