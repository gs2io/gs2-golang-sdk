...
func (p Gs2SkillTreeRestClient) GetServiceVersionAsync(
...
func (p Gs2SkillTreeRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2SkillTreeRestClient) MarkRestrainAsync(
	request *MarkRestrainRequest,
	callback chan<- MarkRestrainAsyncResult,
) {
	path := "/{namespaceName}/user/me/status/{propertyId}/node/restrain/mark"
	if request.NamespaceName != nil && *request.NamespaceName != "" {
		path = strings.ReplaceAll(path, "{namespaceName}", core.ToString(*request.NamespaceName))
	} else {
		path = strings.ReplaceAll(path, "{namespaceName}", "null")
...
func (p Gs2SkillTreeRestClient) MarkRestrain(
	request *MarkRestrainRequest,
...
func preUpdateCurrentTreeMasterAsyncHandler(
	client Gs2SkillTreeRestClient,
	job *core.NetworkJob,
...
func (p Gs2SkillTreeRestClient) PreUpdateCurrentTreeMasterAsync(
...
func (p Gs2SkillTreeRestClient) PreUpdateCurrentTreeMaster(
	request *PreUpdateCurrentTreeMasterRequest,
...
func (p Gs2SkillTreeRestClient) UpdateCurrentTreeMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentTreeMaster(
