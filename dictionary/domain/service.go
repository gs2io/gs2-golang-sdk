...
func (p Gs2Dictionary) CreateNamespace(
    request dictionary.CreateNamespaceRequest,
) (*dictionary.CreateNamespaceResult, error) {
...
func (p Gs2Dictionary) AddEntriesByStampSheet(
    request dictionary.AddEntriesByStampSheetRequest,
) (*dictionary.AddEntriesByStampSheetResult, error) {
    r, err := p.client.AddEntriesByStampSheet(
        &request,
    )
    if err != nil {
        return nil, err
...
func (p Gs2Dictionary) Namespaces(
...
func (p Gs2Dictionary) Namespace(
