...
func (p Namespace) ToDict() map[string]interface{} {
	...
	if p.EntryScript != nil {
		m["entryScript"] = func() map[string]interface{} {
			if p.EntryScript == nil {
				return nil
			}
	...
	if p.DuplicateEntryScript != nil {
		m["duplicateEntryScript"] = p.DuplicateEntryScript
	}
	if p.LogSetting != nil {
...
func (p *EntryModel) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = EntryModel{}
		return nil
	...
	if str == "null" {
		...
		*p = EntryModel{}
		...
		if v, ok := d["entryModelId"]; ok && v != nil {
			var temp interface{}
			if err := json.Unmarshal(*v, &temp); err == nil {
				switch v2 := temp.(type) {
				case string:
				...
				case int64:
					...
					p.EntryModelId = &strValue
				default:
					_ = json.Unmarshal(*v, &p.EntryModelId)
				}
			}
		}
		if v, ok := d["name"]; ok && v != nil {
...
func NewEntryModelFromDict(data map[string]interface{}) EntryModel {
	return EntryModel{
		EntryModelId: func() *string {
			v, ok := data["entryModelId"]
			if !ok || v == nil {
				return nil
			}
			return core.CastString(data["entryModelId"])
		}(),
		Name: func() *string {
			v, ok := data["name"]
			if !ok || v == nil {
...
func (p *EntryModelMaster) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = EntryModelMaster{}
		return nil
...
func (p *Entry) UnmarshalJSON(data []byte) error {
	...
	if str == "null" {
		...
		*p = Entry{}
		...
		if v, ok := d["acquiredAt"]; ok && v != nil {
			_ = json.Unmarshal(*v, &p.AcquiredAt)
		}
	}
	return nil
}
...
func NewEntryFromDict(data map[string]interface{}) Entry {
	return Entry{
		EntryId: func() *string {
			...
			return core.CastString(data["entryId"])
		}(),
		UserId: func() *string {
			v, ok := data["userId"]
			if !ok || v == nil {
		...
		AcquiredAt: func() *int64 {
			v, ok := data["acquiredAt"]
			if !ok || v == nil {
				return nil
			}
			return core.CastInt64(data["acquiredAt"])
		}(),
	}
}
...
func (p *CurrentEntryMaster) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = CurrentEntryMaster{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
