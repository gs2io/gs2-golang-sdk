...
func (p Gs2Money2RestClient) DescribeNamespacesAsync(
	...
	go describeNamespacesAsyncHandler(
		p,
		&core.NetworkJob{
			Url:          p.Session.EndpointHost("money2", EndpointHost).AppendPath(path, replacer),
			Method:       core.Get,
			Headers:      headers,
...
func (p Gs2Money2RestClient) GetServiceVersionAsync(
...
func (p Gs2Money2RestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2Money2RestClient) PreUpdateCurrentModelMasterAsync(
...
func (p Gs2Money2RestClient) PreUpdateCurrentModelMaster(
	request *PreUpdateCurrentModelMasterRequest,
