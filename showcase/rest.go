...
func (p Gs2ShowcaseRestClient) GetServiceVersionAsync(
...
func (p Gs2ShowcaseRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func preUpdateCurrentShowcaseMasterAsyncHandler(
	client Gs2ShowcaseRestClient,
	job *core.NetworkJob,
...
func (p Gs2ShowcaseRestClient) PreUpdateCurrentShowcaseMasterAsync(
...
func (p Gs2ShowcaseRestClient) PreUpdateCurrentShowcaseMaster(
	request *PreUpdateCurrentShowcaseMasterRequest,
...
func (p Gs2ShowcaseRestClient) UpdateCurrentShowcaseMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentShowcaseMaster(
...
func incrementPurchaseCountAsyncHandler(
	client Gs2ShowcaseRestClient,
	job *core.NetworkJob,
...
func (p Gs2ShowcaseRestClient) IncrementPurchaseCountAsync(
	request *IncrementPurchaseCountRequest,
	callback chan<- IncrementPurchaseCountAsyncResult,
) {
	path := "/{namespaceName}/random/showcase/user/me/status/{showcaseName}/{displayItemName}/purchase/count"
	if request.NamespaceName != nil && *request.NamespaceName != "" {
		path = strings.ReplaceAll(path, "{namespaceName}", core.ToString(*request.NamespaceName))
	} else {
		path = strings.ReplaceAll(path, "{namespaceName}", "null")
...
func (p Gs2ShowcaseRestClient) IncrementPurchaseCount(
	request *IncrementPurchaseCountRequest,
