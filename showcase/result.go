...
type PreUpdateCurrentShowcaseMasterResult struct {
	UploadToken *string              `json:"uploadToken"`
	UploadUrl   *string              `json:"uploadUrl"`
	Metadata    *core.ResultMetadata `json:"metadata"`
}

type PreUpdateCurrentShowcaseMasterAsyncResult struct {
	result *PreUpdateCurrentShowcaseMasterResult
	err    error
}

func NewPreUpdateCurrentShowcaseMasterResultFromJson(data string) PreUpdateCurrentShowcaseMasterResult {
	dict := map[string]interface{}{}
	_ = json.Unmarshal([]byte(data), &dict)
	return NewPreUpdateCurrentShowcaseMasterResultFromDict(dict)
}

func NewPreUpdateCurrentShowcaseMasterResultFromDict(data map[string]interface{}) PreUpdateCurrentShowcaseMasterResult {
...
func (p PreUpdateCurrentShowcaseMasterResult) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"uploadToken": p.UploadToken,
		"uploadUrl":   p.UploadUrl,
		"metadata": func() map[string]interface{} {
...
func (p PreUpdateCurrentShowcaseMasterResult) Pointer() *PreUpdateCurrentShowcaseMasterResult {
	return &p
}
