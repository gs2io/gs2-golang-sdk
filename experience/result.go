...
type PreUpdateCurrentExperienceMasterResult struct {
	UploadToken *string              `json:"uploadToken"`
	UploadUrl   *string              `json:"uploadUrl"`
	Metadata    *core.ResultMetadata `json:"metadata"`
}

type PreUpdateCurrentExperienceMasterAsyncResult struct {
	result *PreUpdateCurrentExperienceMasterResult
	err    error
}

func NewPreUpdateCurrentExperienceMasterResultFromJson(data string) PreUpdateCurrentExperienceMasterResult {
	dict := map[string]interface{}{}
	_ = json.Unmarshal([]byte(data), &dict)
	return NewPreUpdateCurrentExperienceMasterResultFromDict(dict)
}

func NewPreUpdateCurrentExperienceMasterResultFromDict(data map[string]interface{}) PreUpdateCurrentExperienceMasterResult {
...
func (p PreUpdateCurrentExperienceMasterResult) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"uploadToken": p.UploadToken,
		"uploadUrl":   p.UploadUrl,
		"metadata": func() map[string]interface{} {
...
func (p PreUpdateCurrentExperienceMasterResult) Pointer() *PreUpdateCurrentExperienceMasterResult {
	return &p
}
