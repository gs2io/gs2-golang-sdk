...
func (p Gs2ProjectRestClient) EnableMfaAsync(
...
func (p Gs2ProjectRestClient) EnableMfa(
	request *EnableMfaRequest,
...
func (p Gs2ProjectRestClient) ChallengeMfaAsync(
...
func (p Gs2ProjectRestClient) ChallengeMfa(
	request *ChallengeMfaRequest,
...
func (p Gs2ProjectRestClient) DisableMfaAsync(
...
func (p Gs2ProjectRestClient) DisableMfa(
	request *DisableMfaRequest,
...
func (p Gs2ProjectRestClient) GetServiceVersionAsync(
...
func (p Gs2ProjectRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2ProjectRestClient) WaitActivateRegionAsync(
	...
	path := "/system/{ownerId}/project/region/{regionName}/activate/wait"
...
func (p Gs2ProjectRestClient) WaitCleanUserDataAsync(
	...
	path := "/system/{ownerId}/project/clean/progress/{transactionId}/wait"
	if request.OwnerId != nil && *request.OwnerId != "" {
		path = strings.ReplaceAll(path, "{ownerId}", core.ToString(*request.OwnerId))
	} else {
		path = strings.ReplaceAll(path, "{ownerId}", "null")
...
func (p Gs2ProjectRestClient) WaitImportUserDataAsync(
	...
	path := "/system/{ownerId}/project/import/progress/{transactionId}/wait"
	if request.OwnerId != nil && *request.OwnerId != "" {
		path = strings.ReplaceAll(path, "{ownerId}", core.ToString(*request.OwnerId))
	} else {
		path = strings.ReplaceAll(path, "{ownerId}", "null")
