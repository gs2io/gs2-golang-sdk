...
type DescribeSendRequestsIterator struct {
...
func NewDescribeSendRequestsIterator(
    friendRequestCache cache.FriendRequestDomainCache,
    client friend.Gs2FriendRestClient,
    namespaceName string,
    accessToken auth.AccessToken,
) DescribeSendRequestsIterator {
    it := DescribeSendRequestsIterator{
...
func (p *DescribeSendRequestsIterator) load() error {
    r, err := p.client.DescribeSendRequests(
...
func (p *DescribeSendRequestsIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeSendRequestsIterator) Next(
