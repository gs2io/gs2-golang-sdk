...
type DescribeReceiveRequestsByUserIdIterator struct {
...
func NewDescribeReceiveRequestsByUserIdIterator(
    friendRequestCache cache.FriendRequestDomainCache,
    client friend.Gs2FriendRestClient,
    namespaceName string,
    userId string,
) DescribeReceiveRequestsByUserIdIterator {
    it := DescribeReceiveRequestsByUserIdIterator{
...
func (p *DescribeReceiveRequestsByUserIdIterator) load() error {
    r, err := p.client.DescribeReceiveRequestsByUserId(
...
func (p *DescribeReceiveRequestsByUserIdIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeReceiveRequestsByUserIdIterator) Next(
