...
type PreUpdateCurrentStaminaMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentStaminaMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentStaminaMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentStaminaMasterRequestFromJson(data string) (PreUpdateCurrentStaminaMasterRequest, error) {
	req := PreUpdateCurrentStaminaMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentStaminaMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentStaminaMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentStaminaMasterRequest {
...
func (p PreUpdateCurrentStaminaMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentStaminaMasterRequest) Pointer() *PreUpdateCurrentStaminaMasterRequest {
	return &p
}
