...
func (p Gs2IdleRestClient) GetServiceVersionAsync(
...
func (p Gs2IdleRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func preUpdateCurrentCategoryMasterAsyncHandler(
	client Gs2IdleRestClient,
	job *core.NetworkJob,
...
func (p Gs2IdleRestClient) PreUpdateCurrentCategoryMasterAsync(
...
func (p Gs2IdleRestClient) PreUpdateCurrentCategoryMaster(
	request *PreUpdateCurrentCategoryMasterRequest,
...
func (p Gs2IdleRestClient) UpdateCurrentCategoryMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentCategoryMaster(
