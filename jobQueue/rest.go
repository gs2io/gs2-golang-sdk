...
func (p Gs2JobQueueRestClient) GetServiceVersionAsync(
...
func (p Gs2JobQueueRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2JobQueueRestClient) DumpUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) DumpUserDataByUserId(
	request *DumpUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) CheckDumpUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) CheckDumpUserDataByUserId(
	request *CheckDumpUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) CleanUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) CleanUserDataByUserId(
	request *CleanUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) CheckCleanUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) CheckCleanUserDataByUserId(
	request *CheckCleanUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) PrepareImportUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) PrepareImportUserDataByUserId(
	request *PrepareImportUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) ImportUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) ImportUserDataByUserId(
	request *ImportUserDataByUserIdRequest,
...
func (p Gs2JobQueueRestClient) CheckImportUserDataByUserIdAsync(
...
func (p Gs2JobQueueRestClient) CheckImportUserDataByUserId(
	request *CheckImportUserDataByUserIdRequest,
...
func deleteByStampTaskAsyncHandler(
	client Gs2JobQueueRestClient,
	job *core.NetworkJob,
...
func (p Gs2JobQueueRestClient) DeleteByStampTaskAsync(
	request *DeleteByStampTaskRequest,
	callback chan<- DeleteByStampTaskAsyncResult,
) {
	path := "/stamp/job/delete"
...
func (p Gs2JobQueueRestClient) DeleteByStampTask(
	request *DeleteByStampTaskRequest,
