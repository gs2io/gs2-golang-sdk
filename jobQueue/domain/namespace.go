...
func (p NamespaceDomain) GetStatus(
    request job_queue.GetNamespaceStatusRequest,
) (*job_queue.GetNamespaceStatusResult, error) {
...
func (p NamespaceDomain) Load(
    request job_queue.GetNamespaceRequest,
) (*job_queue.GetNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Update(
    request job_queue.UpdateNamespaceRequest,
) (*job_queue.UpdateNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Delete(
    request job_queue.DeleteNamespaceRequest,
) (*job_queue.DeleteNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
