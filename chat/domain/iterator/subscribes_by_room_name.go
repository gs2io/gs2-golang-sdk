...
type DescribeSubscribesByRoomNameIterator struct {
...
func NewDescribeSubscribesByRoomNameIterator(
    subscribeCache cache.SubscribeDomainCache,
    client chat.Gs2ChatRestClient,
    namespaceName string,
    roomName string,
) DescribeSubscribesByRoomNameIterator {
    it := DescribeSubscribesByRoomNameIterator{
...
func (p *DescribeSubscribesByRoomNameIterator) load() error {
    r, err := p.client.DescribeSubscribesByRoomName(
...
func (p *DescribeSubscribesByRoomNameIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeSubscribesByRoomNameIterator) Next(
