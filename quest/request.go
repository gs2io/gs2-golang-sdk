...
type PreUpdateCurrentQuestMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentQuestMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentQuestMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentQuestMasterRequestFromJson(data string) (PreUpdateCurrentQuestMasterRequest, error) {
	req := PreUpdateCurrentQuestMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentQuestMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentQuestMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentQuestMasterRequest {
...
func (p PreUpdateCurrentQuestMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentQuestMasterRequest) Pointer() *PreUpdateCurrentQuestMasterRequest {
	return &p
}
