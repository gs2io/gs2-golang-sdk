...
type DescribeDataObjectHistoriesByUserIdIterator struct {
...
func NewDescribeDataObjectHistoriesByUserIdIterator(
    dataObjectHistoryCache cache.DataObjectHistoryDomainCache,
    client datastore.Gs2DatastoreRestClient,
    namespaceName string,
    userId string,
    ...
    it := DescribeDataObjectHistoriesByUserIdIterator{
...
func (p *DescribeDataObjectHistoriesByUserIdIterator) load() error {
    r, err := p.client.DescribeDataObjectHistoriesByUserId(
...
func (p *DescribeDataObjectHistoriesByUserIdIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeDataObjectHistoriesByUserIdIterator) Next(
