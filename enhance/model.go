...
func NewEnhanceFromDict(data map[string]interface{}) Enhance {
    return Enhance {
    }
}

func (p Enhance) ToDict() map[string]interface{} {
    return map[string]interface{} {
    }
}

func (p Enhance) Pointer() *Enhance {
    return &p
}

func CastEnhances(data []interface{}) []Enhance {
	v := make([]Enhance, 0)
	for _, d := range data {
		v = append(v, NewEnhanceFromDict(d.(map[string]interface{})))
	}
	return v
}

func CastEnhancesFromDict(data []Enhance) []interface{} {
    v := make([]interface{}, 0)
    for _, d := range data {
        v = append(v, d.ToDict())
    }
