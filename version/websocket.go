...
func (p Gs2VersionWebSocketClient) getServiceVersionAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2VersionWebSocketClient) GetServiceVersionAsync(
...
func (p Gs2VersionWebSocketClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2VersionWebSocketClient) preUpdateCurrentVersionMasterAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2VersionWebSocketClient) PreUpdateCurrentVersionMasterAsync(
	...
	go p.preUpdateCurrentVersionMasterAsyncHandler(
		&core.WebSocketNetworkJob{
			RequestId: requestId,
			Bodies:    bodies,
		},
...
func (p Gs2VersionWebSocketClient) PreUpdateCurrentVersionMaster(
	request *PreUpdateCurrentVersionMasterRequest,
