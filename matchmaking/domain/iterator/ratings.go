...
type DescribeRatingsIterator struct {
...
func NewDescribeRatingsIterator(
    ratingCache cache.RatingDomainCache,
    client matchmaking.Gs2MatchmakingRestClient,
    namespaceName string,
    accessToken auth.AccessToken,
) DescribeRatingsIterator {
    it := DescribeRatingsIterator{
...
func (p *DescribeRatingsIterator) load() error {
    r, err := p.client.DescribeRatings(
...
func (p *DescribeRatingsIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeRatingsIterator) Next(
