...
func (p Gs2MatchmakingRestClient) GetServiceVersionAsync(
...
func (p Gs2MatchmakingRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2MatchmakingRestClient) PreUpdateCurrentModelMasterAsync(
...
func (p Gs2MatchmakingRestClient) PreUpdateCurrentModelMaster(
	request *PreUpdateCurrentModelMasterRequest,
