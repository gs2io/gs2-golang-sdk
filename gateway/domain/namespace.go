...
func (p NamespaceDomain) GetStatus(
    request gateway.GetNamespaceStatusRequest,
) (*gateway.GetNamespaceStatusResult, error) {
...
func (p NamespaceDomain) Load(
    request gateway.GetNamespaceRequest,
) (*gateway.GetNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Update(
    request gateway.UpdateNamespaceRequest,
) (*gateway.UpdateNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Delete(
    request gateway.DeleteNamespaceRequest,
) (*gateway.DeleteNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
