...
func (p Gs2GatewayRestClient) DescribeNamespacesAsync(
	...
	go describeNamespacesAsyncHandler(
		p,
		&core.NetworkJob{
			Url:          p.Session.EndpointHost("gateway", EndpointHost).AppendPath(path, replacer),
			Method:       core.Get,
			Headers:      headers,
...
func (p Gs2GatewayRestClient) GetServiceVersionAsync(
...
func (p Gs2GatewayRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
