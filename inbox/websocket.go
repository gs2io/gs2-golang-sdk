...
func (p Gs2InboxWebSocketClient) getServiceVersionAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2InboxWebSocketClient) GetServiceVersionAsync(
...
func (p Gs2InboxWebSocketClient) GetServiceVersion(
	request *GetServiceVersionRequest,
