...
type CloseMessageByUserIdRequest struct {
	ContextStack       *string `json:"contextStack"`
	DuplicationAvoider *string `json:"duplicationAvoider"`
	NamespaceName      *string `json:"namespaceName"`
	UserId             *string `json:"userId"`
...
func (p *CloseMessageByUserIdRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = CloseMessageByUserIdRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewCloseMessageByUserIdRequestFromJson(data string) (CloseMessageByUserIdRequest, error) {
	req := CloseMessageByUserIdRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return CloseMessageByUserIdRequest{}, err
	}
	return req, nil
}

func NewCloseMessageByUserIdRequestFromDict(data map[string]interface{}) CloseMessageByUserIdRequest {
...
func (p CloseMessageByUserIdRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName":   p.NamespaceName,
		"userId":          p.UserId,
		"messageName":     p.MessageName,
...
func (p CloseMessageByUserIdRequest) Pointer() *CloseMessageByUserIdRequest {
	return &p
}
...
type PreUpdateCurrentMessageMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentMessageMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentMessageMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentMessageMasterRequestFromJson(data string) (PreUpdateCurrentMessageMasterRequest, error) {
	req := PreUpdateCurrentMessageMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentMessageMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentMessageMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentMessageMasterRequest {
...
func (p PreUpdateCurrentMessageMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentMessageMasterRequest) Pointer() *PreUpdateCurrentMessageMasterRequest {
	return &p
}
