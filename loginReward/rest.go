...
func (p Gs2LoginRewardRestClient) GetServiceVersionAsync(
...
func (p Gs2LoginRewardRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func preUpdateCurrentBonusMasterAsyncHandler(
	client Gs2LoginRewardRestClient,
	job *core.NetworkJob,
...
func (p Gs2LoginRewardRestClient) PreUpdateCurrentBonusMasterAsync(
...
func (p Gs2LoginRewardRestClient) PreUpdateCurrentBonusMaster(
	request *PreUpdateCurrentBonusMasterRequest,
...
func (p Gs2LoginRewardRestClient) UpdateCurrentBonusMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentBonusMaster(
