...
type DescribeFormsByUserIdIterator struct {
...
func NewDescribeFormsByUserIdIterator(
    formCache cache.FormDomainCache,
    client formation.Gs2FormationRestClient,
    namespaceName string,
    moldName string,
    ...
    it := DescribeFormsByUserIdIterator{
        formCache: formCache,
        client: client,
...
func (p *DescribeFormsByUserIdIterator) load() error {
    r, err := p.client.DescribeFormsByUserId(
...
func (p *DescribeFormsByUserIdIterator) HasNext(

) bool {
    return len(p.result) != 0 || !p.last
}

func (p *DescribeFormsByUserIdIterator) Next(
