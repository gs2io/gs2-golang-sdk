...
func (p Gs2FormationRestClient) GetServiceVersionAsync(
...
func (p Gs2FormationRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func preUpdateCurrentFormMasterAsyncHandler(
	client Gs2FormationRestClient,
	job *core.NetworkJob,
...
func (p Gs2FormationRestClient) PreUpdateCurrentFormMasterAsync(
...
func (p Gs2FormationRestClient) PreUpdateCurrentFormMaster(
	request *PreUpdateCurrentFormMasterRequest,
...
func (p Gs2FormationRestClient) UpdateCurrentFormMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentFormMaster(
...
func subMoldCapacityAsyncHandler(
	client Gs2FormationRestClient,
	job *core.NetworkJob,
...
func (p Gs2FormationRestClient) SubMoldCapacityAsync(
	request *SubMoldCapacityRequest,
	callback chan<- SubMoldCapacityAsyncResult,
) {
	path := "/{namespaceName}/user/me/mold/{moldModelName}/sub"
	if request.NamespaceName != nil && *request.NamespaceName != "" {
		path = strings.ReplaceAll(path, "{namespaceName}", core.ToString(*request.NamespaceName))
	} else {
		path = strings.ReplaceAll(path, "{namespaceName}", "null")
...
func (p Gs2FormationRestClient) SubMoldCapacity(
	request *SubMoldCapacityRequest,
