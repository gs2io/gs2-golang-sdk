...
type PreUpdateCurrentFormMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentFormMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentFormMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentFormMasterRequestFromJson(data string) (PreUpdateCurrentFormMasterRequest, error) {
	req := PreUpdateCurrentFormMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentFormMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentFormMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentFormMasterRequest {
...
func (p PreUpdateCurrentFormMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentFormMasterRequest) Pointer() *PreUpdateCurrentFormMasterRequest {
	return &p
}
...
func (p *SetFormRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = SetFormRequest{}
		return nil
...
func NewSetFormRequestFromJson(data string) (SetFormRequest, error) {
	req := SetFormRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return SetFormRequest{}, err
	}
	return req, nil
}

func NewSetFormRequestFromDict(data map[string]interface{}) SetFormRequest {
...
func (p SetFormRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
		"accessToken":   p.AccessToken,
		"moldModelName": p.MoldModelName,
...
func (p SetFormRequest) Pointer() *SetFormRequest {
	return &p
}
