...
func (p Gs2LockWebSocketClient) describeMutexesAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2LockWebSocketClient) DescribeMutexesAsync(
	...
	go p.describeMutexesAsyncHandler(
		&core.WebSocketNetworkJob{
			RequestId: requestId,
			Bodies: bodies,
		},
...
func (p Gs2LockWebSocketClient) DescribeMutexes(
	request *DescribeMutexesRequest,
...
func (p Gs2LockWebSocketClient) describeMutexesByUserIdAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2LockWebSocketClient) DescribeMutexesByUserIdAsync(
	...
	go p.describeMutexesByUserIdAsyncHandler(
		&core.WebSocketNetworkJob{
			RequestId: requestId,
			Bodies: bodies,
		},
...
func (p Gs2LockWebSocketClient) DescribeMutexesByUserId(
	request *DescribeMutexesByUserIdRequest,
