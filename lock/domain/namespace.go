...
func (p NamespaceDomain) GetStatus(
    request lock.GetNamespaceStatusRequest,
) (*lock.GetNamespaceStatusResult, error) {
...
func (p NamespaceDomain) Load(
    request lock.GetNamespaceRequest,
) (*lock.GetNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Update(
    request lock.UpdateNamespaceRequest,
) (*lock.UpdateNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Delete(
    request lock.DeleteNamespaceRequest,
) (*lock.DeleteNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
