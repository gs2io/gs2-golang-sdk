...
func (p NamespaceDomain) GetStatus(
    request exchange.GetNamespaceStatusRequest,
) (*exchange.GetNamespaceStatusResult, error) {
...
func (p NamespaceDomain) Load(
    request exchange.GetNamespaceRequest,
) (*exchange.GetNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Update(
    request exchange.UpdateNamespaceRequest,
) (*exchange.UpdateNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) Delete(
    request exchange.DeleteNamespaceRequest,
) (*exchange.DeleteNamespaceResult, error) {
    request.NamespaceName = &p.namespaceName
...
func (p NamespaceDomain) CreateRateModelMaster(
    request exchange.CreateRateModelMasterRequest,
) (*exchange.CreateRateModelMasterResult, error) {
    request.NamespaceName = &p.namespaceName
