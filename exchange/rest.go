...
func (p Gs2ExchangeRestClient) GetServiceVersionAsync(
...
func (p Gs2ExchangeRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func (p Gs2ExchangeRestClient) PreUpdateCurrentRateMasterAsync(
...
func (p Gs2ExchangeRestClient) PreUpdateCurrentRateMaster(
	request *PreUpdateCurrentRateMasterRequest,
