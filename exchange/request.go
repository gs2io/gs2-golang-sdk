...
type PreUpdateCurrentRateMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentRateMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentRateMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentRateMasterRequestFromJson(data string) (PreUpdateCurrentRateMasterRequest, error) {
	req := PreUpdateCurrentRateMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentRateMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentRateMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentRateMasterRequest {
...
func (p PreUpdateCurrentRateMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentRateMasterRequest) Pointer() *PreUpdateCurrentRateMasterRequest {
	return &p
}
