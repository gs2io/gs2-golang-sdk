...
type PreUpdateCurrentItemModelMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentItemModelMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentItemModelMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentItemModelMasterRequestFromJson(data string) (PreUpdateCurrentItemModelMasterRequest, error) {
	req := PreUpdateCurrentItemModelMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentItemModelMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentItemModelMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentItemModelMasterRequest {
...
func (p PreUpdateCurrentItemModelMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentItemModelMasterRequest) Pointer() *PreUpdateCurrentItemModelMasterRequest {
	return &p
}
