...
type PreUpdateCurrentParameterMasterRequest struct {
	ContextStack  *string `json:"contextStack"`
	NamespaceName *string `json:"namespaceName"`
	DryRun        *bool   `json:"dryRun"`
}

func (p *PreUpdateCurrentParameterMasterRequest) UnmarshalJSON(data []byte) error {
	str := string(data)
	if len(str) == 0 {
		*p = PreUpdateCurrentParameterMasterRequest{}
		return nil
	}
	if str[0] == '"' {
		var strVal string
...
func NewPreUpdateCurrentParameterMasterRequestFromJson(data string) (PreUpdateCurrentParameterMasterRequest, error) {
	req := PreUpdateCurrentParameterMasterRequest{}
	err := json.Unmarshal([]byte(data), &req)
	if err != nil {
		return PreUpdateCurrentParameterMasterRequest{}, err
	}
	return req, nil
}

func NewPreUpdateCurrentParameterMasterRequestFromDict(data map[string]interface{}) PreUpdateCurrentParameterMasterRequest {
...
func (p PreUpdateCurrentParameterMasterRequest) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"namespaceName": p.NamespaceName,
	}
}

func (p PreUpdateCurrentParameterMasterRequest) Pointer() *PreUpdateCurrentParameterMasterRequest {
	return &p
}
