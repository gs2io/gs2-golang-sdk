...
func (p Gs2KeyWebSocketClient) getServiceVersionAsyncHandler(
	job *core.WebSocketNetworkJob,
...
func (p Gs2KeyWebSocketClient) GetServiceVersionAsync(
...
func (p Gs2KeyWebSocketClient) GetServiceVersion(
	request *GetServiceVersionRequest,
