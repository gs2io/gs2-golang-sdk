...
func (p Gs2DistributorRestClient) GetServiceVersionAsync(
...
func (p Gs2DistributorRestClient) GetServiceVersion(
	request *GetServiceVersionRequest,
...
func preUpdateCurrentDistributorMasterAsyncHandler(
	client Gs2DistributorRestClient,
	job *core.NetworkJob,
...
func (p Gs2DistributorRestClient) PreUpdateCurrentDistributorMasterAsync(
...
func (p Gs2DistributorRestClient) PreUpdateCurrentDistributorMaster(
	request *PreUpdateCurrentDistributorMasterRequest,
...
func (p Gs2DistributorRestClient) UpdateCurrentDistributorMasterAsync(
	...
	if request.Settings != nil {
		res, err := p.PreUpdateCurrentDistributorMaster(
