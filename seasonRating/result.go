...
type PreUpdateCurrentSeasonModelMasterResult struct {
	UploadToken *string              `json:"uploadToken"`
	UploadUrl   *string              `json:"uploadUrl"`
	Metadata    *core.ResultMetadata `json:"metadata"`
}

type PreUpdateCurrentSeasonModelMasterAsyncResult struct {
	result *PreUpdateCurrentSeasonModelMasterResult
	err    error
}

func NewPreUpdateCurrentSeasonModelMasterResultFromJson(data string) PreUpdateCurrentSeasonModelMasterResult {
	dict := map[string]interface{}{}
	_ = json.Unmarshal([]byte(data), &dict)
	return NewPreUpdateCurrentSeasonModelMasterResultFromDict(dict)
}

func NewPreUpdateCurrentSeasonModelMasterResultFromDict(data map[string]interface{}) PreUpdateCurrentSeasonModelMasterResult {
...
func (p PreUpdateCurrentSeasonModelMasterResult) ToDict() map[string]interface{} {
	return map[string]interface{}{
		"uploadToken": p.UploadToken,
		"uploadUrl":   p.UploadUrl,
		"metadata": func() map[string]interface{} {
...
func (p PreUpdateCurrentSeasonModelMasterResult) Pointer() *PreUpdateCurrentSeasonModelMasterResult {
	return &p
}
